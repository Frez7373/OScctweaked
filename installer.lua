...
local files={
 {"ui.lua","ui.lua"},{"os.lua","os.lua"},
 {"apps/about.lua","apps/about.lua"},{"apps/calculator.lua","apps/calculator.lua"},{"apps/notepad.lua","apps/notepad.lua"},
 {"apps/files.lua","apps/files.lua"},{"apps/settings.lua","apps/settings.lua"},{"apps/clock.lua","apps/clock.lua"},
 {"apps/system.lua","apps/system.lua"},{"apps/paint.lua","apps/paint.lua"},{"apps/calendar.lua","apps/calendar.lua"},
 {"apps/terminal.lua","apps/terminal.lua"},{"apps/browser.lua","apps/browser.lua"}
}
...
clear(); center(3,"OScctweaked",colors.cyan); center(4,"Windows-style touchscreen OS",colors.lightBlue); center(6,"Installing system files...",colors.white)
...
for i,item in ipairs(files) do
 ...
 term.setCursorPos(2,11); term.setTextColor(colors.lightGray); term.clearLine(); write(string.format("[%d/%d] %-34s",i,#files,remote))
...
clear(); center(5,"Installation complete",colors.lime); center(7,"Touch or press a key to launch",colors.white)
